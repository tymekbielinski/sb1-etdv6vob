...
export function MetricRow({ row, isDefault = false, onReorder, onResize }: MetricRowProps) {
  ...
  const activeMetric = activeId ? definitionsMap.get(activeId as string) : null;
            ...
            {rowMetrics.map((metric) => {
              ...
              return (
                <MetricCard
                  ...
                  isDraggable={true} // Explicitly enable dragging for these cards
